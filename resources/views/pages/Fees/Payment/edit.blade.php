...
@section('css')
    @toastr_css
    @section('title')
        {{trans('accounts.payment_student_edit')}}
    @stop
@endsection
@section('page-header')
    <!-- breadcrumb -->
    <div class="page-title">
        <div class="row">
            <div class="col-sm-6">
                <h4 class="mb-0"> {{trans('accounts.payment_student_edit')}} : {{$paymentStudents->student->name}}</h4>
            </div>
            <div class="col-sm-6">
        ...
        <div class="col-md-12 mb-30">
            <div class="card card-statistics h-100">
                <div class="card-body">
                    ...
                    <form method="post"  action="{{ route('PaymentStudent.update','test') }}" autocomplete="off">
                        @method('PUT')
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input  class="form-control" name="Debit"  value="{{$paymentStudents->amount}}" type="number" >
                                    <input  type="hidden" name="student_id"  value="{{$paymentStudents->student_id}}" class="form-control">
                                   <input  type="hidden" name="id"  value="{{$paymentStudents->id}}" class="form-control">
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="description" id="exampleFormControlTextarea1" rows="3">{{$paymentStudents->description}}</textarea>
                                </div>
                            </div>
                        </div>
