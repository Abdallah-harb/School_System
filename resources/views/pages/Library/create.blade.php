                    ...
                    <form method="post" action="{{ route('library.store')}}" enctype="multipart/form-data">
                        ...
                        <div class="form-row">
                            <div class="form-group col">
                                <label for="inputState">أسم الكتاب<span
                            ...
                            <div class="form-group col">
                                <label for="file_book">تحميل الكتاب<span
                                        class="text-danger">*</span></label>
                                <input type="file" accept="application/pdf" name="file_book" required>
                        ...
                        <div class="form-row">
                            <div class="form-group col">
                                <label for="inputState">{{trans('Students_trans.Grade')}}<span
                                        class="text-danger">*</span></label>
                            ...
                            <div class="form-group col">
                                <label for="section_id">{{trans('Teacher_trans.Name_Teacher')}} : <span
                                        class="text-danger">*</span></label>
